 ...
 */
  ...
  join(String room, String nick,
    ...
    pres = Strophe.$pres({'from': this.connection.jid, 'to': roomNick})
  ...
  leave(String room, String nick, [Function handlerCb, String exitMsg]) {
    ...
    StropheBuilder presence = Strophe.$pres({
      'type': "unavailable",
      'id': presenceid,
  ...
  String message(String room, String nick, String message,
    ...
    StropheBuilder msg = Strophe.$msg({
      'to': roomNick,
      'from': this.connection.jid,
      'type': type,
      'id': msgid
  ...
  String invite(String room, String receiver, [String reason]) {
    ...
    StropheBuilder invitation =
        Strophe.$msg({'from': this.connection.jid, 'to': room, 'id': msgid})
            .c('x', {'xmlns': Strophe.NS['MUC_USER']}).c(
                'invite', {'to': receiver});
    if (reason != null) {
  ...
  directInvite(String room, String receiver, [String reason, String password]) {
    ...
    StropheBuilder invitation =
        Strophe.$msg({'from': this.connection.jid, 'to': receiver, 'id': msgid})
            .c('x', attrs);
    this.connection.send(invitation);
    return msgid;
  }
  ...
  queryOccupants(String room, [Function successCb, Function errorCb]) {
    ...
    StropheBuilder info =
        Strophe.$iq({'from': this.connection.jid, 'to': room, 'type': 'get'})
            .c('query', attrs);
  ...
  configure(String room, [Function successCb, Function errorCb]) {
    StropheBuilder config = Strophe.$iq({'to': room, 'type': "get"})
  ...
  cancelConfigure(String room) {
    StropheBuilder config = Strophe.$iq({'to': room, 'type': "set"})
        .c("query", {'xmlns': Strophe.NS['MUC_OWNER']}).c(
  ...
  saveConfiguration(String room, List<XmlElement> config,
    ...
    StropheBuilder iq = Strophe.$iq({'to': room, 'type': "set"})
        .c("query", {'xmlns': Strophe.NS['MUC_OWNER']});
  ...
  createInstantRoom(String room, [Function successCb, Function errorCb]) {
    StropheBuilder roomiq = Strophe.$iq({'to': room, 'type': "set"})
        .c("query", {'xmlns': Strophe.NS['MUC_OWNER']}).c(
  ...
  setTopic(String room, String topic) {
    StropheBuilder msg = Strophe.$msg(
            {'to': room, 'from': this.connection.jid, 'type': "groupchat"})
   ...
   */
  _modifyPrivilege(String room, StropheBuilder item,
      [String reason, Function handlerCb, Function errorCb]) {
    StropheBuilder iq = Strophe.$iq({'to': room, 'type': "set"})
        .c("query", {'xmlns': Strophe.NS['MUC_ADMIN']}).cnode(item.currentNode);
  ...
  modifyRole(String room, String nick, String role,
      [String reason, Function handlerCb, Function errorCb]) {
    StropheBuilder item = Strophe.$build("item", {'nick': nick, 'role': role});
  ...
  registrationRequest(String room, Function handleCb, [Function errorCb]) {
    StropheBuilder iq =
        Strophe.$iq({'to': room, 'from': this.connection.jid, 'type': "get"})
  ...
  listRooms(String server, [Function handleCb, errorCb]) {
    StropheBuilder iq =
        Strophe.$iq({'to': server, 'from': this.connection.jid, 'type': "get"})
